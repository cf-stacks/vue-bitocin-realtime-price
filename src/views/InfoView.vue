        ...
        <div class="info-card">
          <div class="row">
            <div class="col">
              ...
              <div class="coin-name">{{ currency.name }} ({{ currency.base }}) / <span class="small">{{ currency.quote
              }}</span></div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <span class="price" :style="{ 'color': (ticker.pchg && ticker.pchg > 0) ? 'green' : 'red' }">{{
                  ticker.price
            ...
            <div class="col-md-6 chg-block" :class="[(ticker.percent < 0) ? 'down' : 'up']">
              ...
              <div class="icon-chg text-right">
                {{ parseFloat(ticker.chg).toFixed((currency.quote === 'USDT') ? 3 : 8) }} <span class="x-small">{{
                    currency.quote
                }}</span>
              </div>
            </div>
