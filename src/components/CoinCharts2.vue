            ...
            <div class="col-12  align-items-center">
                <div class="row chart-bar">
                    <div class="chart-type">
                        ...
                        <button class="btn btn-primary btn-sm" :class="[{ 'active': chartType === 'lc' }]"
...
export default {
    ...
    methods: {
        ...
        fetchChartData(isUpdate = false) {
            ...
            const apiurl = encodeURIComponent(`https://pro-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/latest?CMC_PRO_API_KEY=${this.apiKey}&start=1&limit=1&convert=USD`);
            axios({
                method: 'GET',
                url: 'https://copart-cors.herokuapp.com/https://pro-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/latest?CMC_PRO_API_KEY=66897c15-3b80-44fb-aacb-adb6a31353b1&start=1&limit=1&convert=USD'
            }).then(
                function (response) {
